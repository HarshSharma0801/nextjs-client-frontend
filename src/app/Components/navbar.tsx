...
import { Job, Message, Payment, DropDown , Bell } from "../../../public/icons";
...
const NavHead = () => {
  ...
  return (
    <div className={` w-full z-[2] h-fit  `}>
      <nav className="flex  justify-between z-[99]  px-8  py-5 items-center w-full border-b-[0.2px] border-[0.2px]  border-b-gray-200 top-0  bg-white">
        <div className="">
          <div className="flex ">
        ...
        <div
          className="cursor-pointer xl:hidden flex "
          onClick={() => {
            setIsOpen(true);
          }}
        >
        ...
        {isOpen && (
          <>
            <div className="xl:hidden p-2 z-[9997] bg-white fixed w-screen top-[10px] right-[0px]">
              ...
              <div className="text-[#B0B0B0]">Jobs</div>
                  </div>
                  <div
                   className="flex gap-2"
                  >
        ...
        <div className={` items-center xl:flex hidden `}>
          <ul className="flex items-center border-[0.5px] border-[#D1D1D1] rounded-[36px] p-3  xl:gap-12 2xl:gap-24 ">
            <li className="xl:text-[20px] bg-[#DC4A2D] border-[2px] border-[#FCB4A5] py-1 px-3 rounded-[49px] justify-center items-center font-[500] cursor-pointer flex gap-2 leading-[27px] 2xl:text-[1.2rem]">
              <div>
                <Job />
              </div>
            ...
            <li
              onClick={() => {}}
              className="xl:text-[20px]  font-[500] flex gap-2 justify-center items-center cursor-pointer leading-[27px] 2xl:text-[1.2rem]"
            >
              <div className="relative">
                <div className="absolute right-[0] top-0">
                  <svg
             ...
             <div className="flex justify-center items-center gap-3">
                  ...
                  >
                   ...
                   <div className="flex justify-center gap-1 items-center">
                    <div>
                        <Image src={LogImg} className="w-full h-full object-cover" alt="img"/>
                    </div>
